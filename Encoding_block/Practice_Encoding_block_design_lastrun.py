...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Hassl\\OneDrive - Lund University\\Biofinder\\fMRI-tasks\\FacesNamesProfessions_fMRI\\Encoding_Recall\\Practice_Encoding_block_design_lastrun.py',
...
circle = visual.ShapeStim(
    ...
    ori=0.0, pos=(0, 0), anchor='center',
    lineWidth=10.0,     colorSpace='rgb',  lineColor='black', fillColor=None,
    opacity=None, depth=-2.0, interpolate=False)
...
for thisBlock in block:
    ...
    Encoding = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Practice_Encoding_Recall.xlsx', selection=selected_images),

...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Hassl\\OneDrive - Lund University\\Biofinder\\fMRI-tasks\\FacesNamesProfessions_fMRI\\Encoding_Recall\\Encoding_Recall_5_pair_version_lastrun.py',
...
instructions = visual.TextStim(win=win, name='instructions',
    text='Nu är första halvan klar och det är dags för yrken. Ligg still så pratar vi med dig strax. ',
    font='Open Sans',
    pos=(0, 0), height=0.07, wrapWidth=None, ori=0.0, 
    color='black', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
_key_resp_allKeys = []
# keep track of which components have finished
instructions_occupationComponents = [instructions, key_resp]
...
for thisComponent in instructions_occupationComponents:
    if hasattr(thisComponent, "setAutoDraw"):
        thisComponent.setAutoDraw(False)
# the Routine "instructions_occupation" was not non-slip safe, so reset the non-slip timer
routineTimer.reset()

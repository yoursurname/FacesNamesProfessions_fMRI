...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='D:\\Experiments\\ExperimentParadigms_Lund-Oxford\\fMRI_gallerymemory\\GalleryGame_OneShotLearning_fMRI\\Gallery_fMRI_OneShotLearning_practice_lastrun.py',
...
ScrambledTrials_1 = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('OneShotLearning.csv', selection='2:6'),
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('OneShotLearning_conditions.xlsx', selection='2:4'),
...
ScrambledTrials_2 = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('OneShotLearning.csv', selection='6:10'),

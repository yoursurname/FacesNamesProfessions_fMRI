...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\emilo\\OneDrive - Lund University\\Jobb\\Experiments\\Faces_task\\Gallerymemory\\Encoding\\Encoding_lastrun.py',
...
Name_trials = data.TrialHandler(nReps=0.0, method='random', 
...
for thisName_trial in Name_trials:
    ...
    for thisEncoding_Name in Encoding_Name:
        ...
        for thisComponent in CircleComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        Encoding_Name.addData('polygon_3.started', polygon_3.tStartRefresh)
        Encoding_Name.addData('polygon_3.stopped', polygon_3.tStopRefresh)
        # check responses
    ...
    for thisImmediateRecall_Name in ImmediateRecall_Name:
        ...
        for thisComponent in CircleComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        ImmediateRecall_Name.addData('polygon_3.started', polygon_3.tStartRefresh)
        ImmediateRecall_Name.addData('polygon_3.stopped', polygon_3.tStopRefresh)
        # check responses
        if key_resp_3.keys in ['', [], None]:  # No response was made
            key_resp_3.keys = None
...
# completed 0.0 repeats of 'Name_trials'
...
for thisProffession_trial in Proffession_trials:
    ...
    for thisEncoding_Proffession in Encoding_Proffession:
        ...
        for thisComponent in CircleComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        Encoding_Proffession.addData('polygon_3.started', polygon_3.tStartRefresh)
        Encoding_Proffession.addData('polygon_3.stopped', polygon_3.tStopRefresh)
        # check responses
        if key_resp_3.keys in ['', [], None]:  # No response was made
            key_resp_3.keys = None
    ...
    for thisImmediateRecall_Proffession in ImmediateRecall_Proffession:
        ...
        for thisComponent in CircleComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        ImmediateRecall_Proffession.addData('polygon_3.started', polygon_3.tStartRefresh)
        ImmediateRecall_Proffession.addData('polygon_3.stopped', polygon_3.tStopRefresh)
        # check responses
        if key_resp_3.keys in ['', [], None]:  # No response was made
            key_resp_3.keys = None

...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\emilo\\OneDrive - Lund University\\Jobb\\Experiments\\FacesNamesProfessions\\Encoding_Recall\\PilotPractice_Encoding_Recall_lastrun.py',
...
Recall_Name = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('Recall_Pilot.xlsx', selection='15:18'),
...
Recall_Proffession = data.TrialHandler(nReps=1.0, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=data.importConditions('Recall_Pilot.xlsx', selection='45:48'),
